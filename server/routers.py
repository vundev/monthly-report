...
from .controllers import customer_controller, tenant_controller, availability_logs_controller, service_controller
...
apiRouter.include_router(service_controller.router)
